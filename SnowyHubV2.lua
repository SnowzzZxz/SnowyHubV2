...
MainFrame.Size = UDim2.new(0, 500, 0, 400) -- Aumentei pra caber mais opções
...
MainContent.CanvasSize = UDim2.new(0, 0, 0, 600) -- Aumentei pra caber tudo
...
local TabBuy = createTabBtn("Buy", 2)  -- Nova aba de compra
...
-- Opções de Compra (5 ingredientes)
